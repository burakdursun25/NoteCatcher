...
public class AnaMenu extends JPanel {
    ...
    public AnaMenu(JFrame frame) {
        ...
        baslik = new JLabel("Piano Öğrenme Oyunu");
        baslik.setFont(new Font("Arial", Font.BOLD, 36));
        baslik.setForeground(new Color(255, 215, 0));
        baslik.setBounds(200, 20, 500, 50);
        this.add(baslik);

        aciklama = new JLabel("<html><center>🎹 Notalar düşerken doğru tuşa basın!<br>" +
                "<b>Beyaz Tuşlar:</b> A, S, D, F, J, K, L (Do, Re, Mi, Fa, Sol, La, Si)<br>" +
                "⌨️ ESC tuşu ile ana menüye dönebilirsiniz</center></html>");
        ...
        JButton serbest = creatSimpleButton("🎹 Serbest Çalma Modu", new Color(34, 139, 34));
        ...
        JButton cikis = creatSimpleButton("❌ Çıkış", new Color(105, 105, 105));
