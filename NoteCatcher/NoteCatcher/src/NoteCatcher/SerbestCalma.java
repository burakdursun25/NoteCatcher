...
public class SerbestCalma extends JPanel {
    ...
    public SerbestCalma(JFrame frame) {
        ...
        JLabel baslik = new JLabel(" Free Play Mode");
        baslik.setFont(new Font("Arial", Font.BOLD, 32));
        baslik.setForeground(new Color(255, 215, 0));
        baslik.setBounds(320, 30, 400, 50);
        add(baslik);
        
        JLabel aciklama = new JLabel("<html><center>Play any note you want!<br>" +
                "White Keys: A, S, D, F, J, K, L<br>" +
                "Black Keys: W, E, T, Y, U<br>" +
                "Press ESC to return to menu</center></html>");
    ...
    protected void paintComponent(Graphics g) {
        ...
        String bilgi = "Press keys to play notes";
        g.drawString(bilgi, getWidth()/2 - 110, esikY - 30);
    }
